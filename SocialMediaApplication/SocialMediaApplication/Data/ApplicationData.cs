...
namespace SocialMediaApplication.Data
{
    public class ApplicationData
    {
        public static List<User> Users = new List<User>{
            new User{Id = 1 ,Name = "Test 1", Description = "Description for the user 1", Email = "test1@test.com", AvatarURL = "/images/logo.png",CreatedTime = new DateTime(2023,1,29,13,0,0)},
            new User{Id = 2 ,Name = "Test 2",  Description = "Description for the user 2", Email = "test2@test.com",AvatarURL = "/images/logo.png", CreatedTime = new DateTime(2023,2,28,13,0,0)},
            new User{Id = 3 ,Name = "Test 3",  Description = "Description for the user 3", Email = "test3@test.com",AvatarURL = "/images/logo.png", CreatedTime = new DateTime(2023,3,29,13,0,0)},
            new User{Id = 4 ,Name = "Test 4",  Description = "Description for the user 4", Email = "test4@test.com", AvatarURL = "/images/logo.png", CreatedTime = new DateTime(2023,4,29,13,0,0)},
        };

        public static List<Post> Posts = new List<Post>() {
            new Post{Id = 1 ,Content = "Post 1 content", AuthorId = 1, CreatedTime = new DateTime(2023,1,29,13,0,0)},
            new Post{Id = 2 ,Content = "Post 2 content", AuthorId = 2, CreatedTime = new DateTime(2023,2,28,13,0,0)},
        ...
        public static List<Comment> Comments = new List<Comment>() {
            new Comment{Id = 1 , PostId = 1, Content = "Post 1 Comment 1 content", AuthorId = 2, CreatedTime = new DateTime(2023,2,19,13,0,0)},
        ...
        public static List<Like> Likes = new List<Like>() {
            new Like{Id = 1 , PostId = 1, AuthorId = 2, CreatedTime = new DateTime(2023,2,19,13,0,0)},
            ...
            new Like{Id = 5 , PostId = 1, CommentId = 1, AuthorId = 1, CreatedTime = new DateTime(2023,3,19,13,5,0)},
        ...
        public static List<Follow> Follows = new List<Follow>() {
            new Follow{Id = 1 , FollowedId = 1, FollowerId = 2, CreatedTime = new DateTime(2023,2,19,13,0,0)},
